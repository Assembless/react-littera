...
function createLittera(locales, preset) {
  ...
  return {
    ...
    LitteraService: function LitteraService(_ref) {
      ...
      return React.createElement(_LitteraService, {
...
var _LitteraService = function _LitteraService(_ref2) {
  ...
  var _React$useState = React.useState((_ref3 = initialLocale != null ? initialLocale : locales[0]) != null ? _ref3 : 'en_US'),
...
exports.createLittera = createLittera;
